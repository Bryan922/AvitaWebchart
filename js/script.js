...
let marketCap = 110; // Capitalisation fixée à 110M
let volume24h = 25.0; // Volume fixé à 25M
...
function saveMarketState() {
    ...
    const marketState = {
        ...
        marketCap: 110, // Forcer la capitalisation à 110M
        volume24h: 25.0, // Forcer le volume à 25M
        performance7d,
        holders,
        transactions,
        priceHistory,
...
function initializeMarketData() {
    ...
    marketCap = 110.0; // Capitalisation ajustée à 110M
    totalSupply = 100000; // 100M tokens (fixe)
    volume24h = 25.0; // Volume augmenté à 25M
...
function updateMarketData() {
    ...
    // Fixer la capitalisation boursière à 110M avec de très légères variations
    // Variation maximale de ±0.5M pour donner l'impression de mouvement
    const marketCapVariation = (Math.random() * 1.0) - 0.5;
    marketCap = (110.0 + marketCapVariation).toFixed(1);
    
    // Fixer le volume à 25M avec de très légères variations
    // Variation maximale de ±1M pour donner l'impression de mouvement
    const volumeVariation = (Math.random() * 2.0) - 1.0;
    volume24h = (25.0 + volumeVariation).toFixed(1);
...
function updateUIElements(pricePctChange) {
    ...
    // Mettre à jour la capitalisation boursière - fixée à 110M
    ...
    // Mettre à jour le volume sur 24h - fixé à 25M
